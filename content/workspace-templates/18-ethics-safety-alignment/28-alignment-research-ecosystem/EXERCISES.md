# 对齐研究生态：MATS、Redwood、Apollo、METR：练习指南

- 课程路径：phases/18-ethics-safety-alignment/28-alignment-research-ecosystem
- 可运行 Python 文件：main.py

## 练习目标

整理五个非实验室组织的角色、方法和代表性成果。

## 动手练习

1. 运行 code/main.py，记录与“对齐研究生态：MATS、Redwood、Apollo、METR”主题直接相关的关键输出。
