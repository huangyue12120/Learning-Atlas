...
- 课程路径：phases/18-ethics-safety-alignment/22-differential-privacy-for-llms
- 可运行 Python 文件：main.py

## 练习目标

观察 DP-SGD 的裁剪、噪声和 epsilon—utility 权衡。

## 动手练习

1. 运行 code/main.py，记录与“面向 LLM 的差分隐私”主题直接相关的关键输出。
