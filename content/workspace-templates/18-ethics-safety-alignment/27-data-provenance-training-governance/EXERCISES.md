...
- 课程路径：phases/18-ethics-safety-alignment/27-data-provenance-training-governance
- 可运行 Python 文件：main.py

## 练习目标

生成 AB 2013 的十二项数据摘要并标记后续治理义务。

## 动手练习

1. 运行 code/main.py，记录与“数据溯源与训练数据治理”主题直接相关的关键输出。
