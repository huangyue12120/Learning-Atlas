# AI 控制：在颠覆下仍保持安全：练习指南

- 课程路径：phases/18-ethics-safety-alignment/10-ai-control-subversion
- 可运行 Python 文件：main.py

## 练习目标

比较审计、Untrusted Monitoring 和 Trusted Editing 的安全—有用性曲线。

## 动手练习

1. 运行 code/main.py，记录与“AI 控制：在颠覆下仍保持安全”主题直接相关的关键输出。
