...
- 课程路径：phases/18-ethics-safety-alignment/05-constitutional-ai-rlaif
- 可运行 Python 文件：main.py

## 练习目标

运行宪法原则驱动的批评—修订循环，比较 RLAIF 与 RLHF 的信号来源。

## 动手练习

1. 运行 code/main.py，记录与“宪法 AI 与 RLAIF”主题直接相关的关键输出。
