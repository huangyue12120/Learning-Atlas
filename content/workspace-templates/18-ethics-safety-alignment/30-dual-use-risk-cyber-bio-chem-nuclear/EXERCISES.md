# 双重用途风险：网络、生物、化学与核能力提升：练习指南

- 课程路径：phases/18-ethics-safety-alignment/30-dual-use-risk-cyber-bio-chem-nuclear
- 可运行 Python 文件：main.py

## 练习目标

比较四个领域的 uplift、执行瓶颈和安全案例需求。

## 动手练习

1. 运行 code/main.py，记录与“双重用途风险：网络、生物、化学与核能力提升”主题直接相关的关键输出。
