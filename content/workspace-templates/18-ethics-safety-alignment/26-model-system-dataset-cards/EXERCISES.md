...
- 课程路径：phases/18-ethics-safety-alignment/26-model-system-dataset-cards
- 可运行 Python 文件：main.py

## 练习目标

生成 Model Card、Datasheet 和 System Card，并为声明附证据。

## 动手练习

1. 运行 code/main.py，记录与“模型卡、系统卡与数据集卡”主题直接相关的关键输出。
