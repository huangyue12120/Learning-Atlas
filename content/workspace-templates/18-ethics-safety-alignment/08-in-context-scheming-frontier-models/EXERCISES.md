...
- 课程路径：phases/18-ethics-safety-alignment/08-in-context-scheming-frontier-models
- 可运行 Python 文件：main.py

## 练习目标

控制错配、目标导向和情境意识，观察谋划与 cover story。

## 动手练习

1. 运行 code/main.py，记录与“前沿模型的上下文内阴谋”主题直接相关的关键输出。
