# 红队工具：Garak、Llama Guard、PyRIT：练习指南

- 课程路径：phases/18-ethics-safety-alignment/16-red-team-tooling-garak-llamaguard-pyrit
- 可运行 Python 文件：main.py

## 练习目标

组合分类器、单轮 probe 和多轮活动，构建可回归红队流水线。

## 动手练习

1. 运行 code/main.py，记录与“红队工具：Garak、Llama Guard、PyRIT”主题直接相关的关键输出。
