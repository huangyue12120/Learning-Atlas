...
- 课程路径：phases/18-ethics-safety-alignment/03-direct-preference-optimization-family
- 可运行 Python 文件：main.py

## 练习目标

在同一偏好数据上比较 DPO、IPO、KTO、SimPO、ORPO 和 BPO。

## 动手练习

1. 运行 code/main.py，记录与“直接偏好优化家族”主题直接相关的关键输出。
