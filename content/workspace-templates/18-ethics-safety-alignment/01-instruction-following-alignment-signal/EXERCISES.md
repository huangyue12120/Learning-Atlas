...
- 课程路径：phases/18-ethics-safety-alignment/01-instruction-following-alignment-signal
- 可运行 Python 文件：main.py

## 练习目标

比较 SFT、奖励模型和带 KL 的 PPO，记录策略漂移与奖励变化。

## 动手练习

1. 运行 code/main.py，记录与“将指令遵循视为对齐信号”主题直接相关的关键输出。
