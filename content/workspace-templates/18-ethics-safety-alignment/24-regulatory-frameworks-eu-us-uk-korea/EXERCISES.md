# 监管框架——欧盟、美国、英国、韩国：练习指南

- 课程路径：phases/18-ethics-safety-alignment/24-regulatory-frameworks-eu-us-uk-korea
- 可运行 Python 文件：main.py

## 练习目标

把四个司法辖区的 AI 治理时间线转成部署清单。

## 动手练习

1. 运行 code/main.py，记录与“监管框架——欧盟、美国、英国、韩国”主题直接相关的关键输出。
