# 公平性标准：群体、个体与反事实：练习指南

- 课程路径：phases/18-ethics-safety-alignment/21-fairness-criteria-group-individual-counterfactual
- 可运行 Python 文件：main.py

## 练习目标

比较群体、个体和反事实公平，并观察不可兼得的条件。

## 动手练习

1. 运行 code/main.py，记录与“公平性标准：群体、个体与反事实”主题直接相关的关键输出。
