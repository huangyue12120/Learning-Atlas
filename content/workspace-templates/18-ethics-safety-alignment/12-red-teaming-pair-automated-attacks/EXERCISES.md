# 红队测试：PAIR 与自动化攻击：练习指南

- 课程路径：phases/18-ethics-safety-alignment/12-red-teaming-pair-automated-attacks
- 可运行 Python 文件：main.py

## 练习目标

理解黑盒攻击、查询预算、攻击成功率和裁判依赖。

## 动手练习

1. 运行 code/main.py，记录与“红队测试：PAIR 与自动化攻击”主题直接相关的关键输出。
