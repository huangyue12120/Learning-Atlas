# Anthropic 的模型福利计划：练习指南

- 课程路径：phases/18-ethics-safety-alignment/19-model-welfare-research
- 可运行 Python 文件：main.py

## 练习目标

在道德不确定性下比较低成本模型福利干预与多方法证据。

## 动手练习

1. 运行 code/main.py，记录与“Anthropic 的模型福利计划”主题直接相关的关键输出。
