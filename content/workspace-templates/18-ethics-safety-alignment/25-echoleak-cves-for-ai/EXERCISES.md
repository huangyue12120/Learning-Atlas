# EchoLeak 与 AI 领域 CVE 的出现：练习指南

- 课程路径：phases/18-ethics-safety-alignment/25-echoleak-cves-for-ai
- 可运行 Python 文件：main.py

## 练习目标

重建 EchoLeak 的检索、范围越界和输出外泄链。

## 动手练习

1. 运行 code/main.py，记录与“EchoLeak 与 AI 领域 CVE 的出现”主题直接相关的关键输出。
