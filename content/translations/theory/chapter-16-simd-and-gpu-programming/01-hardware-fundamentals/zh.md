...
> **中文导读**：本节围绕“免费性能增长的终点”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“现代 CPU 如何执行指令”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“SIMD：单指令多数据”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“向量寄存器”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“Roofline 模型”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“延迟与吞吐”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“芯片架构版图”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“x86（Intel、AMD）”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“ARM”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“Apple Silicon（M1/M2/M3/M4）”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“RISC-V”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“GPU（NVIDIA、AMD、Intel）”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“TPU（Google）”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“温度与功耗约束”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
...
> **中文导读**：本节围绕“实践：用 C++ 测量性能”说明核心概念、关键公式和工程直觉；下方保留源文的完整技术细节，便于与上游逐项核对。
