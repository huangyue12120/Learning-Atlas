...
> **中文导读**：本节围绕“统一化的动机”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“任意到任意模型”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“共享骨干网络与模态专用编码器/解码器”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“多模态 token 化”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“训练配方：分阶段预训练与联合微调”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“多模态思维链推理”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“多模态智能体”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“基准与评估”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“世界模型”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
