...
> **中文导读**：本节围绕“边缘约束”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“模型压缩流水线”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“端侧运行时”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“编译器栈”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“硬件目标”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。

### 移动 GPU

> **中文导读**：本节围绕“移动 GPU”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“神经处理单元（NPU）”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“端侧 LLM”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“联邦学习”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
...
> **中文导读**：本节围绕“延迟优化”说明概念、适用条件与工程取舍；下方技术细节保持与上游 main 快照一致。
