...
当前发布版本为 **v0.16.0**（2026-09-01）：首页展示 Phase 0-19 的完整实践地图与 20 章、104 篇笔记的完整理论目录。实践阅读器现已开放 Phase 0-14 的 333 节课程，Phase 15-19 的 190 节内容显示为“已审核，待接入”；当前开放课程的 235 张上下文理论卡已提供可展开的直觉、关键点、应用和自检问题，12 / 104 篇审核中文理论全文已覆盖 154 / 311 张理论卡，所有理论原文入口均打开官方上游最新 `main`。内容仓库维护 523 节审核中文实践译文、228 份中文测验、327 套 VS Code/Python 工作区模板与练习指南，以及 311 条人工批准的理论关联。P14 的 54 节课程、测验、Python 工作区和理论卡已通过发布门禁。
...
- 目前实践阅读器发布 Phase 0-14 的 333 节经审核实践主线和已批准理论卡；其中 327 节提供 VS Code/Python 工作区模板与练习指南。Phase 15-19 的 190 节译文已审核但尚未接入阅读器。完整理论目录已经开放；只有审核且来源指纹与本地 `main` 快照匹配的中文正文会在应用内发布，理论原文链接始终指向可能变化的官方 `main`。
...
发布信息、已知限制和备份建议请参阅 [v0.16.0 发布说明](docs/release-notes.md)。
