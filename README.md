...
当前发布版本为 **v0.10.0**（2026-08-28）：实践上游已同步到 `39ea8a1c6d0b61f071226eff7ede4d4105fed820`；内容仓库现有 Phase 0–19 共 511 节经审核中文实践译文。阅读器开放 Phase 0–13 的 279 节课程，Phase 14–19 的 232 节内容已完成审核，待接入阅读器；当前开放范围配套中文测验 174 份、VS Code/Python 工作区模板与练习指南 273 套，理论关联共 311 条，其中 206 条已批准。
...
发布信息、已知限制和备份建议请参阅 [v0.10.0 发布说明](docs/release-notes.md)。
