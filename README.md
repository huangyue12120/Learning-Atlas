...
当前发布版本为 **v0.9.0**（2026-08-28）：实践上游已同步到 `39ea8a1c6d0b61f071226eff7ede4d4105fed820`；内容仓库新增 Phase 19 共 85 节经审核中文实践译文，累计 503 节。阅读器继续开放 Phase 0–13 的 271 节课程，Phase 14–19 的 232 节内容已完成审核，待接入阅读器；配套中文测验 34 份，理论关联共 311 条，其中 206 条已批准。
...
1. 在左侧课程栏选择课程；“未开始、学习中、已理解、需复习”会与当前课程区分显示。阅读器当前开放 Phase 0–13，共 271 节课；Phase 14–19 的已审核译文保存在内容仓库，尚未接入阅读器。
...
- 目前阅读器发布 Phase 0–13 的 271 节经审核实践主线和已批准理论卡；Phase 14–19 的 232 节译文已审核但尚未接入阅读器，完整理论知识库中文化仍作为独立内容流推进。
...
发布信息、已知限制和备份建议请参阅 [v0.9.0 发布说明](docs/release-notes.md)。
