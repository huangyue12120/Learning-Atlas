...
当前发布版本为 **v0.3**（2026-08-23）：已完成 Phase 0–11 共 223 节经审核的中文实践译文。阅读器当前开放 Phase 0–6 的 139 节课，配套中文测验 34 份；理论关联共 201 条，其中 118 条已批准。
...
发布信息、已知限制和备份建议请参阅 [v0.3 发布说明](docs/release-notes.md)。
