...
当前发布版本为 **v0.4**（2026-08-24）：已完成 Phase 0–11 共 223 节经审核的中文实践译文。阅读器当前开放 Phase 0–9 的 182 节课，配套中文测验 34 份；理论关联共 244 条，其中 146 条已批准。
...
1. 在左侧课程栏选择课程；“未开始、学习中、已理解、需复习”会与当前课程区分显示。阅读器当前开放 Phase 0–9；Phase 10–11 的译文已完成审核，待接入阅读器。
...
- 目前阅读器发布 Phase 0–9 的经审核实践主线和已批准理论卡；Phase 10–11 的 41 节译文已完成审核但尚未接入，完整理论知识库中文化也作为独立内容流推进。
...
发布信息、已知限制和备份建议请参阅 [v0.4 发布说明](docs/release-notes.md)。
