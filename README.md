...
当前发布版本为 **v0.7.0**（2026-08-27）：实践上游已同步到 `39ea8a1c6d0b61f071226eff7ede4d4105fed820`，并更新受影响译文；阅读器继续开放 Phase 0–13 共 271 节经审核的中文实践译文。上游 Phase 13 新增的第 24–31 课尚无中文译文，仍未接入阅读器；配套中文测验 34 份，理论关联共 223 条，其中 138 条已批准。
...
1. 在左侧课程栏选择课程；“未开始、学习中、已理解、需复习”会与当前课程区分显示。阅读器当前开放 Phase 0–13，共 271 节课；上游新增的 Phase 13·24–31 尚未接入。
...
- 目前阅读器发布 Phase 0–13 的 271 节经审核实践主线和已批准理论卡；上游新增的 Phase 13·24–31 尚无中文改编，完整理论知识库中文化仍作为独立内容流推进。
...
发布信息、已知限制和备份建议请参阅 [v0.7.0 发布说明](docs/release-notes.md)。
