...
当前发布版本为 **v0.11.0**（2026-08-28）：实践上游已同步到 `39ea8a1c6d0b61f071226eff7ede4d4105fed820`；内容仓库现有 Phase 0–19 共 511 节经审核中文实践译文。阅读器开放 Phase 0–13 的 279 节课程，Phase 14–19 的 232 节内容已完成审核，待接入阅读器；当前开放范围配套中文测验 174 份、VS Code/Python 工作区模板与练习指南 273 套，理论关联共 311 条，已全部完成人工审核并批准。
...
1. 在左侧课程栏选择课程；“未开始、学习中、已理解、需复习”会与当前课程区分显示。阅读器当前开放 Phase 0–13，共 279 节课；Phase 14–19 的已审核译文保存在内容仓库，尚未接入阅读器。
...
- 目前阅读器发布 Phase 0–13 的 279 节经审核实践主线和已批准理论卡；其中 273 节提供 VS Code/Python 工作区模板与练习指南。Phase 14–19 的 232 节译文已审核但尚未接入阅读器，完整理论知识库中文化仍作为独立内容流推进。
...
发布信息、已知限制和备份建议请参阅 [v0.11.0 发布说明](docs/release-notes.md)。
