...
当前发布版本为 **v0.6**（2026-08-26）：已完成 Phase 0–13 共 271 节经审核的中文实践译文，阅读器已全部开放；配套中文测验 34 份，理论关联共 223 条，其中 138 条已批准。
...
1. 在左侧课程栏选择课程；“未开始、学习中、已理解、需复习”会与当前课程区分显示。阅读器当前开放 Phase 0–13，共 271 节课。
...
- 目前阅读器发布 Phase 0–13 的 271 节经审核实践主线和已批准理论卡；完整理论知识库中文化仍作为独立内容流推进。
...
发布信息、已知限制和备份建议请参阅 [v0.6 发布说明](docs/release-notes.md)。
