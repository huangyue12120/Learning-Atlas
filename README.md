...
当前发布版本为 **v0.25.2**（2026-09-24）：首页展示 Phase 0-19 的完整实践地图与 20 章、104 篇笔记的完整理论目录。实践阅读器现已开放 Phase 0-18 的 438 节课程，Phase 19 的 85 节内容显示为“已审核，待接入”；当前开放课程的 289 张上下文理论卡已提供可展开的直觉、关键点、应用和自检问题，89 / 104 篇审核中文理论全文已覆盖 311 / 311 张理论卡，所有理论原文入口均打开官方上游最新 `main`。内容仓库维护 523 节审核中文实践译文、288 份中文测验、430 套 VS Code/Python 工作区模板与练习指南，以及 311 条人工批准的理论关联。P18 新增的 30 份中文测验、30 套 Python 工作区和 5 张 rich theory cards 已通过结构、来源指纹、API 和回退门禁；T1–T6 的 89 篇理论正文与 255 个中文 SVG 图示已完成复核；P16 的 25 节课程及其两个 TypeScript 例外继续保持已发布状态。
...
发布信息、已知限制和备份建议请参阅 [v0.25.2 发布说明](docs/release-notes.md)。
