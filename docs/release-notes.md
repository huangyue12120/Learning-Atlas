# Learning Atlas v0.2 发布说明

发布日期：2026-08-21。

本版以中文内容扩展、术语统一和译文语言复核为主。v0.1 的应用与内容边界仍记录在 [`ADR 0018`](adr/0018-freeze-v0-1-around-reviewed-practice-and-context.md) 中。

## 本版交付

- 完成 Phase 0–11 共 223 节经审核的中文实践译文。
- 阅读器继续开放 Phase 0–3，共 65 节课程；Phase 4–11 的 158 节译文已完成审核，暂存于内容仓库，等待后续接入。
...
- Phase 4–11 的译文尚未进入阅读器；当前应用目录只包含 Phase 0–3。
- 中文测验只覆盖 Phase 0–1。
