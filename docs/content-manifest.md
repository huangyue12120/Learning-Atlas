...
阅读器当前开放 Phase 0–3；Phase 4–11 的译文已完成审核，但尚未接入阅读器。
...
| Phase 4「计算机视觉」 | 28 | 0 | 已审核，待接入 |
| Phase 5「自然语言处理基础到进阶」 | 29 | 0 | 已审核，待接入 |
| Phase 6「语音与音频」 | 17 | 0 | 已审核，待接入 |
...
理论关联共 201 条：118 条 `approved`，其中当前开放课程的已批准关联会在应用中展示；83 条 `proposed` 仅保留在内容仓库中。第 15 课的中心极限定理卡指向 `chapter 04 - statistics/03. sampling.md`，并提供对应的版本化中文专题笔记。
...
- 阅读器目前只加载 Phase 0–3 的 65 节课程；Phase 4–11 的 158 节译文尚未接入课程目录。
